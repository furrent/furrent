...
Furrent2::Furrent2() {
    ...
    _workers.launch(
        std::bind(&Furrent2::thread_main, this, _1, _2, _3)
    );
}
...
void Furrent2::thread_main(mt::Runner runner, WorkerState& state, size_t index) {
...
void Furrent2::add_torrent(const std::string& filename) {
...
const std::list<TorrentDescriptor>& Furrent2::get_descriptors() const {
    return _descriptors;
}
